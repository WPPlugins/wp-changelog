				...
				if ( isset( $extra['translations'] ) && is_array( $extra['translations'] ) && ! empty( $extra['translations'] ) ) {
					...
					foreach ( $extra['translations'] as $translation ) {
						...
						if ( 'core' === $translation['type'] ) {
							...
							// Save data
							$this->write_log( 'update', 'wordpress/core', 'WordPress', 'wordpress', $translation['version'], 'translation' );
						}
						...
						if ( 'plugin' === $translation['type'] && isset( $translation['slug'] ) ) {
							...
							if ( is_array( $plugin_data ) && ! empty( $plugin_data ) ) {
								...
								foreach ( $plugin_data as $key => $value ) {
									...
									// Save data
									$this->write_log( 'update', $translation['slug'] .'/' . $key, $value['Name'], $value['DomainPath'], $translation['version'], 'translation' );
								}
							}
						}
						...
						if ( 'theme' === $translation['type'] && isset( $translation['slug'] ) ) {
							...
							if ( $theme_info ) {
								...
								// Save data
								$this->write_log( 'update', $translation['slug'], $theme_data['theme_name'], $theme_data['theme_domain'], $translation['version'], 'translation' );
							}
						}
					}
				}
